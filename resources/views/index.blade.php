...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] min-h-screen flex flex-col items-center justify-center p-6 lg:p-8 transition-colors duration-300">
    ...
    <main class="flex flex-col lg:flex-row items-center w-full max-w-5xl gap-10 mt-20 lg:mt-0">
        ...
        <div class="flex-1">
            <div class="w-full h-[320px] lg:h-[420px] bg-gradient-to-tr from-[#fff2f2] to-[#fde8e8] dark:from-[#1D0002] dark:to-[#2b0005] rounded-2xl flex items-center justify-center shadow-inner">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-40 h-40 opacity-80 dark:opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
