<div>
    <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Pendaftaran(Appointments) ({{ $totalAppointment }})</h2>
    ...
    <div class="overflow-x-auto ">
        <table class="min-w-full border-spacing-y-3 text-xs whitespace-nowrap">
            ...
            <tbody class="text-gray-700 ">
                ...
                <tr class="bg-white dark:bg-gray-800 shadow rounded-lg text-sm hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"">
