    ...
    <div x-data="{ tab: @entangle('tab').live }"" class=" !mt-0 !p-0">
        ...
        <div class="flex gap-3 mb-4">
            <button @click="$wire.set('tab','pasien')"
                :class="tab === 'pasien' ? 'bg-blue-600 dark:bg-gray-800 dark:border  text-white' :
                    'bg-gray-100 dark:bg-gray-300 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition">
                Pasien
            </button>

            <button @click="$wire.set('tab','dokter')"
                :class="tab === 'dokter' ? 'bg-blue-600 dark:bg-gray-800 dark:border text-white' :
                    'bg-gray-100 dark:bg-gray-300 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition">
                Dokter
            </button>
            ...
            <button @click="$wire.set('tab','admin')"
                :class="tab === 'admin' ? 'bg-blue-600 dark:bg-gray-800 dark:border text-white' :
                    'bg-gray-100 dark:bg-gray-300 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition">
                Admin
            </button>
            ...
            <div class="flex gap-3">
                ...
                <template x-if="tab === 'pasien'">
                    <div class="flex gap-3">
                        ...
                        <div
                            class="px-3 py-2 border rounded-lg text-sm text-gray-700 dark:focus:bg-gray-700
                                dark:text-white focus:ring focus:ring-blue-200 dark:focus:ring-gray-200">
            ...
            <table class="min-w-full text-left border-collapse overflow-x-auto whitespace-nowrap">
                ...
                <tbody x-show="tab === 'pasien'" class=" text-[14px]">
                    @forelse ($pasiens as $item)
                        <tr
                            class="border-b text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white">
                            ...
                            <td class="py-2 px-4  ">{{ $item->pasien->phone ?? '-' }}</td>
