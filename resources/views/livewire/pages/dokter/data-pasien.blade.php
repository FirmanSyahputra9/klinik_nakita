    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            <div class="md:hidden space-y-4">
                ...
                @forelse ($antrian as $item)
                    <div
                        class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-800 shadow relative">
                        ...
                        <div class="pr-12">
                            ...
                            <div class="mt-3 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <p><span class="font-medium">Jenis Kelamin:</span> {{ $item->pasien->gender_label }}
                                </p>
                                <p><span class="font-medium">No. RM:</span> {{ $item->pasien->no_rm }}</p>
                                <p><span class="font-medium">Tgl Kunjungan:</span>
