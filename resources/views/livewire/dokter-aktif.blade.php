<div class="p-4 rounded-xl bg-white shadow-lg dark:bg-gray-200">
    <div class="text-lg lg:text-xl font-medium text-gray-600 dark:text-gray-800">
        Status Ketersediaan:
>
        <div class="flex items-center gap-6 mt-3" wire:change="updateStatus">
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="aktif_yes" class="text-base font-semibold text-green-600 dark:text-green-400 select-none">
                    Aktif (Tersedia)
                </label>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="aktif_no" class="text-base font-semibold text-red-600 dark:text-red-400 select-none">
                    Tidak Aktif
                </label>
            </div>
