<x-layouts.app :title="__('Dashboard')">
    <main class="flex flex-col lg:flex-row gap-6 p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <article class="bg-white rounded-xl shadow-md p-5 flex flex-col gap-3 border border-gray-100 hover:shadow-lg transition">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Akses hasil pemeriksaan Lab kapan saja.</p>
                    </div>
        ...
        <!-- RIGHT SIDEBAR -->
        <aside class="w-full lg:w-72 bg-white rounded-3xl p-6 shadow space-y-6">
            ...
            <!-- Health Stats -->
            <div class="grid grid-cols-2 text-center text-sm gap-4">
            ...
            <!-- Health Notes -->
            <a href="{{ route('riwayat.index') }}"
                class="w-full bg-slate-50 hover:bg-sky-200 transition py-2 rounded-xl flex items-center justify-center text-sm font-medium text-gray-800 shadow">
                <span>Riwayat</span>
    ...
    <!-- Resep Obat -->
    <section class="bg-white rounded-xl shadow overflow-hidden mx-4 md:mx-6 mb-6">

        <!-- Header -->
        <header class="bg-gradient-to-r from-sky-100 to-sky-200 p-4 space-y-1">
