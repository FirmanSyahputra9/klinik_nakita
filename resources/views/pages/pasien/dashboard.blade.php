<x-layouts.app :title="__('Dashboard')">
  ...
  <div class="flex-1 space-y-6 p-4 md:p-6 w-full">
        ...
        @if ($item)
            <!-- Resep Card -->
            <div class="card bg-white dark:bg-gray-800 rounded-lg w-full shadow overflow-hidden">
                    ...
                    <div class="card flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <h3 class="card font-bold text-xl text-gray-900 dark:text-gray-100">
                                {{ $item->antrian->data_pemeriksaan->diagnosa ?? '-' }}
                            </h3>
                            ...
                            <div class="card flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-700 dark:text-gray-100">
                                ...
                                <div class="card flex items-center gap-1">
                                    ...
                                    <span>{{ $item->antrian->registrasi->tanggal_kunjungan ?? '-' }}</span>
                                </div>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span>{{ $item->antrian->created_at ?? '0' }}</span>
                                </div>
                                ...
                                <div class="flex items-center gap-1">
                                   <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor"
                                    ...
                                    <span>{{ $item->antrian->dokter->name ?? '-' }}</span>
                                </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {!! collect(explode(',', $resepItem->waktu_konsumsi ?? '-'))
        ...
        @else
            <p class="text-center text-gray-500 dark:text-gray-400">Data Tidak Tersedia</p>
        @endif
