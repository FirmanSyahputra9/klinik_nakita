        ...
        <div class="card bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="card p-4">
                ...
                <div class="card flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <!-- Icon -->
                    <div class="card w-12 h-12 bg-white/50 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <!-- Info -->
                    <div class="flex-1">
                        <h3 class="card font-bold text-xl text-gray-900">
                            {{ $item->data_pemeriksaan->diagnosa ?? '-' }}
                        </h3>

                        <div class="card flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-700">
            ...
            <div class="p-6">
                ...
                <div class="card border border-gray-200 rounded-lg p-4 mb-4">
                    ...
                    <div class="card flex items-start gap-3 mb-4">
                        ...
                        <div class="card w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="card w-6 h-6 text-blue-600" fill="none" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex-1">
                            <h5 class="card font-semibold text-gray-900">{{ $resep->obat->nama ?? '-' }}</h5>
                            <p class="card text-sm text-gray-600">{{ $resep->kuantitas ?? '-' }}
                                {{ $resep->obat->satuan ?? '-' }}
                            </p>
                            <p class="card text-sm text-gray-600">{{ $resep->dosis ?? '' }}
                                {{ $resep->obat->satuan ?? '-' }}
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            <p class="card text-sm font-semibold text-gray-700 mb-1">Frekuensi:</p>
                        ...
                        <div>
                            <p class="card text-sm font-semibold text-gray-700 mb-1">Waktu Konsumsi:</p>
                        ...
                        <div>
                            <p class="card text-sm font-semibold text-gray-700 mb-1">Harga:</p>
                            <p class="card text-sm text-gray-600">{{ $resep->obat->harga ?? '' }}</p>
                        </div>
