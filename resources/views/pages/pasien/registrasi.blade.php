            ...
            <div class="card bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6">
                ...
                <form action="{{ route('registrasi.store') }}" method="POST">
                    ...
                    <div class="card grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="name"
                                class="card block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">
                        ...
                        <div>
                            ...
                            <input id="nomor_rm" type="text" name="nomor_rm"
                        ...
                        <div>
                            ...
                            <input id="no_telepon" type="tel" name="no_telepon"
                        ...
                        <div class="w-full card ">
                            ...
                            <div
                                class="card bg-gray-100 dark:bg-gray-900 p-4 rounded-lg text-sm border border-gray-200">
                                <input type="number" name="dokter_id" value="{{ $dokter->id }}"
                                    hidden>
                        ...
                        <div x-data="{
                            ...
                            <div>
                                ...
                                <input id="date" type="date" name="tanggal_kunjungan" x-model="tanggal"
                        ...
                        <div x-data="{ keluhan: '{{ old('keluhan') }}', max: 255 }" class="md:col-span-2">
                            ...
                            <div class="flex justify-between items-center mb-1">
                                <label for="keluhan"
                                    class="card block text-sm font-medium text-gray-700 dark:text-gray-100">
                                    Keluhan
                                </label>

                                <span class="text-xs" :class="keluhan.length >= max ? 'text-red-600' : 'text-gray-400'">
                                    <span x-text="keluhan.length"></span>/<span x-text="max"></span>
                                </span>
                            </div>

                            <textarea id="keluhan" name="keluhan" rows="4" x-model="keluhan" maxlength="255"
