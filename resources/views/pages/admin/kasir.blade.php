            ...
            <div class="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-xl p-6" x-transition.scale>
                ...
                <div class="border-t border-gray-200 pt-4 space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="px-2.5 py-1 rounded-full text-xs font-semibold"
                            :class="{
                                'bg-green-100 dark:bg-gray-300 text-green-700 dark:text-gray-900': viewData.status === 'Lunas',
                                'bg-red-100 dark:bg-gray-300 text-red-700 dark:text-gray-900': viewData.status !== 'Lunas'
                            }"
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <input type="number" min="0"
                            class="border rounded-lg px-2 py-1 w-28 text-right"
                ...
                <div class="flex justify-end gap-3 mt-6">
                    ...
                    <form x-bind:action="'{{ route('kasir.konfirmasi', $item->id) }}'" method="POST">
                        ...
                        <input type="hidden" name="biaya_layanan"
                            x-model="viewData.biaya_layanan" required>

                        <button type="submit"
                            :disabled="!viewData.biaya_layanan || viewData.biaya_layanan <= 0"
                            :class="{
                                    'bg-blue-500 hover:bg-blue-600 text-white': viewData.biaya_layanan > 0,
                                    'bg-gray-300 text-gray-500 cursor-not-allowed': !viewData.biaya_layanan || viewData.biaya_layanan <= 0
                                }"
                    ...
                    @else
                    <button disabled
                        class="px-4 py-2 bg-gray-300 rounded-lg text-gray-500 cursor-not-allowed">
                        Konfirmasi Pembayaran
                    </button>
                    @endif
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 w-full max-w-lg rounded-2xl shadow-xl p-6" x-transition.scale>
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button class="text-gray-500 hover:text-red-500"
                        @click="showPendapatan = false">✕</button>
                </div>
