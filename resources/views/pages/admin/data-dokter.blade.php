<x-layouts.app :title="__('Data Dokter')">
    <div>
                    ...
                    @foreach ($dokters as $dokter)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center flex justify-center gap-2">
                                <a onclick="openModal('Anda yakin ingin membuat jadwal dokter online?', 'online')" href="#"
                                    class="p-2 bg-green-500 text-white rounded hover:bg-green-600 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-3">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                    </svg>
                                </a>
                                <button onclick="openModal('Anda yakin ingin membuat jadwal dokter offline?', 'offline')" class="p-2 bg-red-500 text-white rounded hover:bg-red-600 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-3">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                                    </svg>
                                </button>
                                <button onclick="openModal('Anda yakin ingin menghapus jadwal dokter?', 'delete')" class="p-2 bg-red-500 text-white rounded hover:bg-red-600 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-3">
        ...
        <!-- Modal Background -->
        <div id="customModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center
