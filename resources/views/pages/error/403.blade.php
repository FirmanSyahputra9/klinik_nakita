<div class="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 flex flex-col items-center justify-center px-6 py-10 relative overflow-hidden">

    {{-- Floating circles --}}
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 left-20 w-64 h-64 bg-red-200 rounded-full opacity-20 blur-3xl animate-pulse"></div>
        <div class="absolute bottom-20 right-20 w-96 h-96 bg-yellow-200 rounded-full opacity-20 blur-3xl animate-pulse"></div>
    </div>

    <div class="text-center relative z-10">
        <div class="relative inline-block">
            <h1 class="text-9xl font-extrabold bg-gradient-to-r from-red-600 via-orange-600 to-yellow-600 bg-clip-text text-transparent tracking-widest animate-pulse">
                403
            </h1>
