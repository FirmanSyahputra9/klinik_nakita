<x-layouts.app :title="__('Dashboard')">
    ...
    <div class="relative w-full max-w-6xl mx-auto rounded-xl overflow-hidden bg-linear-to-r from-white to-[#EFF4FA] p-5 py-10 mb-10 mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 items-start">
            <div class="flex flex-col items-start space-y-6">
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800 mt-1">12 Juni 2016</p>
                </div>
                <div class="flex flex-col space-y-4 w-full">
                    <a href="mailto:nabilahdaa@gmail.com" class="flex items-center bg-blue-50 border border-blue-200 rounded-full pr-4 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer w-full max-w-[280px]">
                        ...
                        <span class="ml-3 text-blue-800 font-medium text-sm md:text-base truncate">nabilahdaa@gmail.com</span>
                    </a>

                    <a href="tel:+6282160455334" class="flex items-center bg-blue-50 border border-blue-200 rounded-full pr-4 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer w-full max-w-[280px]">
                        <div class="p-3 bg-blue-200 rounded-l-full">
                            <svg class="w-5 h-5 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                        </div>
                        <span class="ml-3 text-blue-800 font-medium text-sm md:text-base">0821-6045-5334</span>
                    </a>
                </div>
            </div>

            <div class="col-span-1 md:col-span-1 lg:col-span-1 flex flex-col items-center text-center md:items-start md:text-left">
                <h2 class="text-3xl lg:text-4xl font-extrabold text-[#1F75BF] leading-tight">dr. Nabila Huwaida</h2>
                <p class="text-lg lg:text-xl font-medium text-gray-600 mt-1">Dokter Umum</p>
                
                <div class="mt-4 inline-block bg-[#E2ECF6] p-1 px-3 text-sm rounded-full text-blue-700 font-semibold shadow-inner">
                    Spesialis Paru-Paru
                </div>                
            ...
            <div class="relative hidden lg:block self-stretch -mr-12 -my-10">
                <img
                    ...
                    alt="Foto Dokter Nabila Huwaida"
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mb-10 max-w-6xl mx-auto">
        ...
        {{-- Kartu 1 --}}
        <div class="bg-white p-3 sm:p-6 rounded-xl shadow-lg border-l-4 border-blue-500 transition duration-300 hover:shadow-xl">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-[10px] sm:text-sm font-semibold text-blue-600 mb-1 uppercase tracking-wider">
                        Pasien Hari Ini
                    </p>
                    <h2 class="text-2xl sm:text-4xl font-extrabold text-gray-900">12</h2>
                </div>
                <svg class="w-5 h-5 sm:w-8 sm:h-8 text-blue-500 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Kartu 2 --}}
        <div class="bg-white p-3 sm:p-6 rounded-xl shadow-lg border-l-4 border-green-500 transition duration-300 hover:shadow-xl">
            <div class="flex justify-between items-start">
                <div>
                ...
                <svg class="w-5 h-5 sm:w-8 sm:h-8 text-green-500 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- Kartu 3 --}}
        <div class="bg-white p-3 sm:p-6 rounded-xl shadow-lg border-l-4 border-yellow-500 transition duration-300 hover:shadow-xl">
            <div class="flex justify-between items-start">
                <div>
                ...
                <svg class="w-5 h-5 sm:w-8 sm:h-8 text-yellow-500 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- Kartu 4 --}}
        <div class="bg-white p-3 sm:p-6 rounded-xl shadow-lg border-l-4 border-red-500 transition duration-300 hover:shadow-xl">
            <div class="flex justify-between items-start">
                <div>
                ...
                <svg class="w-5 h-5 sm:w-8 sm:h-8 text-red-500 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
