<x-layouts.app :title="__('Dashboard')">
    ...
    <div class="grid grid-cols-2 gap-6">
        <!-- Janji Temu -->
        <div class="bg-white p-6 rounded-xl shadow">
            <h3 class="font-semibold mb-4">Janji Temu Berikutnya</h3>
            <div class="space-y-4">
        ...
        <!-- Notifikasi -->
        <div class="bg-white p-6 rounded-xl shadow">
            <h3 class="font-semibold mb-4">Notifikasi Terbaru</h3>
            <ul class="space-y-4 text-sm">
                <li class="flex items-start space-x-2">
                    <span class="text-red-500 mt-1">●</span>
                    <div>
                        <p>Hasil lab Ahmad Rizki sudah keluar</p>
                ...
                <li class="flex items-start space-x-2">
                    <span class="text-red-500 mt-1">●</span>
                    <div>
                        <p>Pasien baru: Linda Sari mendaftar</p>
                ...
                <li class="flex items-start space-x-2">
                    <span class="text-red-500 mt-1">●</span>
                    <div>
                        <p>Resep untuk Tono Wijaya telah dikirim</p>
